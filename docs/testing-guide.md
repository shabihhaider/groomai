...
## Known Issues & Pending Integration Points

> These are features that are **built** but don't yet have entry points wired into the tabs. They function correctly if navigated to directly.

| Feature | Status | Entry Point Needed |
|---|---|---|
| AI Routine Generator | ✅ Built | Button in Routines tab |
| AI Skin Analysis | ✅ Built | Button in Profile tab |
| Product Scanner | ✅ Built | Button in Barber tab |
| Hair Loss Tracker | ✅ Built | Button in Profile tab |
| Affiliate links in routine steps | ⚠️ Service ready | Wire `getProductForRoutineStep` into RoutineCard |
| Affiliate section in Profile "My Kit" | ⚠️ Service ready | Add section to profile.tsx |

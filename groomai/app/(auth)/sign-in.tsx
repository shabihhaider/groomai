...
export default function SignInScreen() {
    ...
    const signInBtnScale = useSharedValue(1)
    const signInBtnAnimated = useAnimatedStyle(() => ({ transform: [{ scale: signInBtnScale.value }] }))
        ...
        >
            ...
            >
                ...
                <Animated.View entering={FadeInDown.delay(200).duration(500)} style={styles.form}>
                    ...
                    {/* Sign In button */}
                    <Animated.View style={signInBtnAnimated}>
                    <Pressable
                        style={[styles.primaryBtn, loading && styles.btnDisabled]}
                        onPress={handleSignIn}
                        onPressIn={() => { signInBtnScale.value = withSpring(0.96, { damping: 15 }) }}
                        onPressOut={() => { signInBtnScale.value = withSpring(1, { damping: 15 }) }}
                        disabled={loading}
                    >
                        {loading ? (
